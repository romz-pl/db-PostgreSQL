...
static inline void
pg_atomic_unlocked_write_u32_impl(volatile pg_atomic_uint32 *ptr, uint32_t val)
{
	ptr->value = val;
}
#endif
...
static inline uint32_t
pg_atomic_exchange_u32_impl(volatile pg_atomic_uint32 *ptr, uint32_t xchg_)
{
    uint32_t old;
	while (true)
	{
...
static inline uint32_t
pg_atomic_fetch_sub_u32_impl(volatile pg_atomic_uint32 *ptr, int32_t sub_)
{
...
static inline uint32_t
pg_atomic_fetch_and_u32_impl(volatile pg_atomic_uint32 *ptr, uint32_t and_)
{
    uint32_t old;
	while (true)
	{
...
static inline uint32_t
pg_atomic_add_fetch_u32_impl(volatile pg_atomic_uint32 *ptr, int32_t add_)
{
...
static inline uint32_t
pg_atomic_sub_fetch_u32_impl(volatile pg_atomic_uint32 *ptr, int32_t sub_)
{
...
pg_atomic_exchange_u64_impl(volatile pg_atomic_uint64 *ptr, uint64_t xchg_)
{
    uint64_t old;
	while (true)
	{
...
static inline void
pg_atomic_write_u64_impl(volatile pg_atomic_uint64 *ptr, uint64_t val)
{
	/*
...
static inline uint64_t
pg_atomic_fetch_sub_u64_impl(volatile pg_atomic_uint64 *ptr, int64_t sub_)
{
...
static inline uint64_t
pg_atomic_fetch_and_u64_impl(volatile pg_atomic_uint64 *ptr, uint64_t and_)
{
    uint64_t old;
	while (true)
	{
...
static inline uint64_t
pg_atomic_fetch_or_u64_impl(volatile pg_atomic_uint64 *ptr, uint64_t or_)
{
    uint64_t old;
	while (true)
	{
...
static inline uint64_t
pg_atomic_add_fetch_u64_impl(volatile pg_atomic_uint64 *ptr, int64_t add_)
{
...
static inline uint64_t
pg_atomic_sub_fetch_u64_impl(volatile pg_atomic_uint64 *ptr, int64_t sub_)
{
