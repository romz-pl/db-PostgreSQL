...
void
pg_atomic_init_u32_impl(volatile pg_atomic_uint32 *ptr, uint32_t val_)
{
	StaticAssertStmt(sizeof(ptr->sema) >= sizeof(slock_t),
...
void
pg_atomic_write_u32_impl(volatile pg_atomic_uint32 *ptr, uint32_t val)
{
	/*
...
uint32_t
pg_atomic_fetch_add_u32_impl(volatile pg_atomic_uint32 *ptr, int32_t add_)
{
    uint32_t		oldval;
...
void
pg_atomic_init_u64_impl(volatile pg_atomic_uint64 *ptr, uint64_t val_)
{
	StaticAssertStmt(sizeof(ptr->sema) >= sizeof(slock_t),
...
uint64_t
pg_atomic_fetch_add_u64_impl(volatile pg_atomic_uint64 *ptr, int64_t add_)
{
    uint64_t		oldval;
