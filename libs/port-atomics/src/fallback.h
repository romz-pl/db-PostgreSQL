...
extern void pg_atomic_init_u32_impl(volatile pg_atomic_uint32 *ptr, uint32_t val_);

#define PG_HAVE_ATOMIC_WRITE_U32
extern void pg_atomic_write_u32_impl(volatile pg_atomic_uint32 *ptr, uint32_t val);
...
extern uint32_t pg_atomic_fetch_add_u32_impl(volatile pg_atomic_uint32 *ptr, int32_t add_);
...
extern void pg_atomic_init_u64_impl(volatile pg_atomic_uint64 *ptr, uint64_t val_);
...
extern uint64_t pg_atomic_fetch_add_u64_impl(volatile pg_atomic_uint64 *ptr, int64_t add_);
