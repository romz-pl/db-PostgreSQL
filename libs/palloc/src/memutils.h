...
#define AllocHugeSizeIsValid(size)	((size_t) (size) <= MaxAllocHugeSize)
...
extern size_t GetMemoryChunkSpace(void *pointer);
 ...
 */
extern MemoryContext MemoryContextCreate(NodeTag tag, size_t size,
