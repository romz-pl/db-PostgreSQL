 ...
 */
MemoryContext
MemoryContextCreate(NodeTag tag, size_t size,
					MemoryContextMethods *methods,
					MemoryContext parent,
					const char *name)
{
	MemoryContext node;
    size_t		needed = size + strlen(name) + 1;
 ...
 */
void *
MemoryContextAlloc(MemoryContext context, size_t size)
{
	void	   *ret;
 ...
 */
void *
MemoryContextAllocZero(MemoryContext context, size_t size)
{
	void	   *ret;
 ...
 */
void *
MemoryContextAllocZeroAligned(MemoryContext context, size_t size)
{
	void	   *ret;
 ...
 */
void *
MemoryContextAllocExtended(MemoryContext context, size_t size, int flags)
{
	void	   *ret;
 ...
 */
void *
MemoryContextAllocHuge(MemoryContext context, size_t size)
{
	void	   *ret;
 ...
 */
void *
repalloc_huge(void *pointer, size_t size)
{
	MemoryContext context = GetMemoryChunkContext(pointer);
	void	   *ret;
 ...
 */
char *
pnstrdup(const char *in, size_t len)
{
